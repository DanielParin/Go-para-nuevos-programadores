...
/*
El main es el punto básico de ejecución del programa, es decir, siempre se buscará la función main para ejecutarse primero.
...
func main() {
	...
	/*
		Una variable es un espacio que almacenara un tipo de dato. Según el tipo de dato tendrá unas características y unas operaciones asociadas a ellos,
		(no es lo mismo una suma de dos números enteros que una suma de caracteres).
	...
	*/
	...
	/*
		El Printf nos sirve para formatear la cadena. Podemos poner que tipo de dato poner y a qué variable corresponde.
		...
		Aquí los tipos de datos más usados:
	...
	*/
	...
	/*
		Aquí decimos que las dos primeras cadenas o elementos que encuentre en la consola sean el nombre y apellido.
		Si está vacía no da error, pero no coge la variable, y si es de otro tipo que no sea string te lo transforma a
		string, por ejemplo un número.
	*/
	...
	*/
	...
	/*
		Al poner const, nos referimos a
	*/
}
